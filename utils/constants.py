...
MATERIAL_COLORS = {
    ...
    "Avg Avg Air Nutrients in Roots": "darkorange",
    "Avg Air Nutrients in Leafs": "lime",
    "Avg Air Nutrients in Flowers": "deeppink",
    "Avg Soil Nutrients in Roots": "saddlebrown",
    "Avg Soil Nutrients in Leafs": "green",
    "Avg Soil Nutrients in Flowers": "darkmagenta",
    "Avg Root Structural Integrity": "chocolate",
    "Avg Leaf Structural Integrity": "lime",
    "Avg Flower Structural Integrity": "deeppink",
    "Root Age": "chocolate",
    "Leaf Age": "lime",
    "Flower Age": "deeppink",
    "Agent Count": "red",
